...
#set of options for each question respectively
answer_choice= [
    ["A. 15th August",
	"B. 2nd October" ,
	"C. 26th January", 
...
user_sel = [] #variable to store user selected options

indexes =[] # variable to store randomized set of questions

#function generating random questions and storing them into indexes
def gen():
    global indexes
...
#function for storing user name and creating rules page
def start():
    global text
...
#functions to display result of user attempted quiz
def showmarks(score):
    global text,bg
    ques.destroy()
    r1.destroy()
...
q = 1 
#function to accept user answers
def answer():
